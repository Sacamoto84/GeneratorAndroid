...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Audio_createSLEngine(JNIEnv *env, jclass type, jint sampleRate, jint framesPerBuf) {
  SLresult result;
...
extern "C" JNIEXPORT float JNICALL Java_com_example_spectrogrammer34_Audio_getSampleRate(JNIEnv *env, jclass type)
{
    return engine.fastPathSampleRate_;
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_example_spectrogrammer34_Audio_createAudioRecorder(JNIEnv *env, jclass type)
{
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Audio_deleteAudioRecorder(JNIEnv *env, jclass type) {
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Audio_startPlay(JNIEnv *env, jclass type) {
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Audio_stopPlay(JNIEnv *env, jclass type) {
  engine.recorder_->Stop();
  //delete engine.recorder_;
  //engine.recorder_ = nullptr;
}

extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Audio_pausePlay(JNIEnv *env, jclass type) {
  engine.recorder_->Pause();
}

extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Audio_deleteSLEngine( JNIEnv *env, jclass type)
{
