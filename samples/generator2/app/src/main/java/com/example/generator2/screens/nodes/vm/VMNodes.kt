    ...
    fun snapshotFromGenerator(): StepParams {
        ...
        return StepParams(
            ch1 = ChannelParams(
                ...
                amEnabled = d.chL_AM_EN.value,
                amFr = Operand.Const(d.chL_AM_Fr.value),
                amMod = d.chL_AM_Filename.value,
                fmEnabled = d.chL_FM_EN.value,
                //BASE и есть частота несущей: движок пишет их в одно поле,
                //поэтому в снимке её не дублируем
                fmBase = null,
                fmDev = Operand.Const(d.chL_FM_Dev.value),
            ...
            ch2 = ChannelParams(
                ...
                amEnabled = d.chR_AM_EN.value,
                amFr = Operand.Const(d.chR_AM_Fr.value),
                amMod = d.chR_AM_Filename.value,
                fmEnabled = d.chR_FM_EN.value,
                fmBase = null,
                fmDev = Operand.Const(d.chR_FM_Dev.value),
                fmFr = Operand.Const(d.chR_FM_Fr.value),
                fmMod = d.chR_FM_Filename.value,
            ),
        )
    }
