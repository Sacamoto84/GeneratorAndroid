...
//        if (mEngineHandle != 0L) return native_resetAllData(mEngineHandle)
//    }
//
...
//        if (mEngineHandle != 0L) native_setCH_Send_Buffer(mEngineHandle, CH, mod, buf!!)
//    }
//
//    //fun setFM_Base(CH: Int, fr: Float) { if (mEngineHandle != 0L) native_setCH_FM_Base( mEngineHandle, CH, fr ) }
//    fun setFM_Dev(CH: Int, fr: Float) {
//        if (mEngineHandle != 0L) native_setCH_FM_Dev(mEngineHandle, CH, fr)
//    }
//
//    /**
...
//        if (mEngineHandle != 0L) native_setParameterFloat(mEngineHandle, index, value)
//    }
//
//    fun setParameterInt(index: Int, value: Int) {
//        if (mEngineHandle != 0L) native_setParameterInt(mEngineHandle, index, value)
//    }
//
//
//    // Native methods
